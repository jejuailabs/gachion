...
| Axle Journey | 마을 관련 사업 | 마을의 필요→가치onAI의 첫 답→현장 확인·실증 흐름, 사진 한 장→중앙 LIVE 소식, 마을별 로컬 체험→연중 제주 카탈로그 인포그래픽, Ma2Sa 업무 도구 5종과 경감 업무, 대표 현장 이력·교육·시연, 제주 실증 계획 |
...
- 제주마을 공개 화면은 LIVE 사진 소식과 로컬 체험 목록을 보여준다. '1년 내내'는 중앙 카탈로그에서 상시 발견할 수 있는 구조를 뜻하며 예약 가능일·실제 홍보 성과를 보장하지 않는다. 자동 카드뉴스·영상 제작과 외부 채널 예약 발행은 구축 계획이다.
- Ma2Sa의 공고문 분석·영수증→엑셀·양식 변환·회의록 정리·대신 읽어주기는 사용자 제공 교육용 시연 화면 메뉴를 따른다. 영수증·회의록의 작업 화면은 시연 자료로 확인했으며 실제 시간 절감량은 실증 전이다.
