...
- Asset: `dist/assets/gachi-on-logo.png` (transparent PNG).
- Generated with the built-in image generation tool; applied in the header and footer.
- The first syllable stacks ㄱ over the Jeju arae-a dot, followed by 치.
- ON represents switching on a warm light in the face of unfamiliar AI.
- Alt text preserves the brand reading and meaning without relying on an archaic Hangul font.
